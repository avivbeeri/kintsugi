...
public class KnowledgeHelper {
    ...
    public static final Map<Integer, Set<Enchantment>> ENCHANTMENT_CATEGORIES = Map.of(
            1, Set.of(SHARPNESS, BLAST_PROTECTION, PROJECTILE_PROTECTION,
            ...
            2, Set.of(ALL_DAMAGE_PROTECTION, UNBREAKING, FIRE_ASPECT, KNOCKBACK, SWEEPING_EDGE, FLAMING_ARROWS,
                    PIERCING, QUICK_CHARGE, THORNS, PUNCH_ARROWS),
            3, Set.of(BLOCK_FORTUNE, DEPTH_STRIDER, SOUL_SPEED, SWIFT_SNEAK, RESPIRATION, CHANNELING,
                    LOYALTY, MOB_LOOTING),
            4, Set.of(SILK_TOUCH),
            5, Set.of(MENDING, INFINITY_ARROWS, RIPTIDE)
    );
