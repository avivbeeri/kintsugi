...
public class ModAdvancementGenerator extends ForgeAdvancementProvider {
     ...
     */
    public ModAdvancementGenerator(PackOutput output, CompletableFuture<HolderLookup.Provider> registries, ExistingFileHelper existingFileHelper, List<AdvancementGenerator> subProviders) {
